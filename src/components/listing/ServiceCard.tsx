...
import { MapPin, Star, MoreHorizontal, CheckCircle, Heart, Phone, Send, PhoneCall, ImageIcon, Zap } from 'lucide-react'
...
export function ServiceCard({ provider, onSave, isSaved = false, className }: ServiceCardProps) {
